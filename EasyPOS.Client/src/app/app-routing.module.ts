...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'purchases', loadChildren: () => import('./modules/purchases/purchases.module').then(m => m.PurchasesModule), canActivateChild: [AuthGuard] },
            { path: 'sales', loadChildren: () => import('./modules/sales/sales.module').then(m => m.SalesModule), canActivateChild: [AuthGuard] },
            ...
            { path: 'hrm', loadChildren: () => import('./modules/hrm/hrm.module').then(m => m.HRMModule), canActivateChild: [AuthGuard] }
        ]
    },

...
import { PurchaseReturnPaymentListComponent } from '../purchase-return-payment-list/purchase-return-payment-list.component';
...
export class PurchaseReturnListComponent {
  ...
  private addPayment(event: any) {
    this.customDialogService.open<{ id: string; purchaseReturn: PurchaseReturnModel; }>(
      PurchaseReturnPaymentDetailComponent,
      { id: CommonConstants.EmptyGuid, purchaseReturn: event.data },

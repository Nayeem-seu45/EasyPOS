...
public class UpdatePurchaseReturnPaymentCommandValidator : AbstractValidator<UpdatePurchaseReturnPaymentCommand>
{
    public UpdatePurchaseReturnPaymentCommandValidator()
    {

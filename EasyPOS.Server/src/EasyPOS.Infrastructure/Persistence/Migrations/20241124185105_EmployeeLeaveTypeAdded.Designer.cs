...
namespace EasyPOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241124185105_EmployeeLeaveTypeAdded")]
    partial class EmployeeLeaveTypeAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.Designation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.EmployeeLeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.Holiday", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.LeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<bool>("IsSandwichAllowed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.WorkingShift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.WorkingShiftDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.Purchases.PurchaseReturnPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("PurchaseReturnPayments");
                });
            ...
            modelBuilder.Entity("EasyPOS.Domain.Sales.SaleReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("SoldReferenceNo")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("EasyPOS.Domain.Sales.SaleReturnDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.Sales.SaleReturnPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EasyPOS.Domain.Stakeholders.Customer", b =>
                {
                    ...
                    b.Property<decimal>("TotalSaleReturnAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("EasyPOS.Domain.Stocks.Stock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("Stocks", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Stock_UnitCost", "[UnitCost] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.WorkingShiftDetail", b =>
                {
                    b.HasOne("EasyPOS.Domain.HRM.WorkingShift", "WorkingShift")
                        .WithMany("WorkingShiftDetails")
            ...
            modelBuilder.Entity("EasyPOS.Domain.Sales.SaleReturnDetail", b =>
                {
                    b.HasOne("EasyPOS.Domain.Sales.SaleReturn", "SaleReturn")
            ...
            modelBuilder.Entity("EasyPOS.Domain.Stocks.Stock", b =>
                {
                    b.HasOne("EasyPOS.Domain.Products.Product", "Product")
                        .WithMany("Stocks")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("EasyPOS.Domain.Products.Warehouse", "Warehouse")
                        .WithMany("Stocks")
            ...
            modelBuilder.Entity("EasyPOS.Domain.HRM.WorkingShift", b =>
                {
                    b.Navigation("WorkingShiftDetails");
                });
            ...
            modelBuilder.Entity("EasyPOS.Domain.Sales.SaleReturn", b =>
                {
                    ...
                    b.Navigation("SaleReturnPayments");
                });
